...
local shift = 0.05
local b1 = circle(UDim2.new(0.300+shift,300,0.400,28),"POW")
local b2 = circle(UDim2.new(0.300+shift,300,0.400,90),"DASH")
local b3 = circle(UDim2.new(0.300+shift,300,0.400,54),"SHORT\nDASH")
